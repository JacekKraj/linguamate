  ...
  return (
    <ArticleWrapper>
      ...
      <ArticleParagraph>
        ...
        element missing for you and probably 99% of other non-native speakers: the accent. The
        problem we all face is that even though we&apos;ve been learnig English for ages, our accent
        doesn&apos;t seem to improve as the time flies. For this reason, you might wonder if
        it&apos;s at all possible for a foreigner to ever sound like a Londoner without being born
        there.
      </ArticleParagraph>
      <ArticleImage
        src="/images/articles/britishAccent.webp"
        alt="Learning British accent at home"
      />
      <ArticleSubHeader>Is it possible for foreigners to learn a British accent?</ArticleSubHeader>
      <ArticleParagraph>
        At this point, you can calm down because the answer is yes. From my personal experience, I
        can tell you that there are only two ways to achieve satisfying results. These are:
      </ArticleParagraph>
      ...
      <ArticleParagraph>
        ...
        same thing for years, yet the results aren&apos;t satisfying. It turns out there are two
        main reasons for their success and your struggle
      </ArticleParagraph>
      <ArticleUnorderedList>
        <ArticleUnorderedListItem>
      ...
      <ArticleParagraph>
        ...
        speaking, they subconsciously repeat what they&apos;ve already heard. And it doesn&apos;t
        just apply to the words they say. It also affects how they say them, so to the accent. This
        conclusion shouldn&apos;t be surprising. That&apos;s how you learned your native language.
        As a baby you were constantly listening to native speakers talking all the time and
        eventually you started repeating what you heard.
      </ArticleParagraph>
      <ArticleParagraph>
        Do you already see what&apos;s the difference between your situation and the one described
        in above? The problem is that even when you speak or listen to English, your conversation
      ...
      <ArticleParagraph>
        Let&apos;s start with the active ones. As proven above, the key to success is repeating
        after native speakers. To do this at home you&apos;ll need only two things: an English
        version of a book you like and its audiobook read by a British native speaker (both are easy
        to be found for free online). What you&apos;ll want to do is to read aloud from the book
        repeating after the speaker. Let them read the sentence first, listen closely to how they
        pronounce every single word and then pause the audiobook to repeat aloud, reading exactly
        the same sentence from the book. What you must pay attention to is to mimic the accent as
        closely as possible. For this reason, the repeated parts shouldn&apos;t consist of more than
        10 words, so you can correctly remember they way the speaker pronounced the words. If a
        sentence is too long, split it to smaller parts. I suggest doing this exercise everyday for
        30 minutes to achieve satisfying results.
      </ArticleParagraph>
      <ArticleParagraph>
        ...
        surrounded by the spoken English all the time. It can be audiobooks, podcasts, YouTube
        videos or anything else where you&apos;ll be able to hear native speakers talking. You can
        listen while eating, training, driving a car or whenever possible. Do you know what&apos;s
        the best part of this excercise? There is no need for you to pay attention to what they say.
        It&apos;s completely enough for it to play in the background, allowing your brain
        subconsciously get used to and learn the pronunciation. Just play the audio and focus on
        whatever else you want. There&apos;s no time limit for this exercise. The more, the better.
      </ArticleParagraph>
